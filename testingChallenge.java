...
public class testingChallenge {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//WebElement we1=driver.findElement(By.xpath("//header/div[3]/div[1]/div[1]/div[6]/ul[1]/li[1]/a[1]"));
	...
	//	driver.findElement(By.cssSelector("a.standard-checkout")).click();
		//driver.findElement(By.linkText("a[href*='=order']")).click();
		Thread.sleep(5000);
		//driver.findElement(By.xpath(("[class='button btn btn-default']"))).click();
		System.out.println("Print1");
		//driver.findElement(By.cssSelector("a.Proceed to checkout")).click();
